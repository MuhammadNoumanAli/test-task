            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Register User Form</h5>
                        ...
                        <form method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select id="user_role" class="form-control" name="user_role">
                                        @foreach($roles as $role)
                                            <option value="{{ $role->name }}" @selected(old('user_role'))> {{ $role->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('user_role')
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <input id="contact_number" type="text" class="form-control @error('contact_number') is-invalid @enderror" name="contact_number" value="{{ old('contact_number') }}" required placeholder="Contact Number">
                                ...
                                <div class="col-md-12 mt-3 custom-file-input-back">
                                    ...
                                    <textarea id="about" name="about" type="text" class="form-control @error('about') is-invalid @enderror"> {{ old('about') }} </textarea>
